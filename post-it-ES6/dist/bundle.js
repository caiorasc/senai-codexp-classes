...
var criaComponenteInputTitulo = function criaComponenteInputTitulo(notaAlterada, posicao) {
    var props = {
        key: 'note-title',
...
var criaComponenteFormTextarea = function criaComponenteFormTextarea(notaAlterada, posicao) {
    var props = {
        key: 'note-body',
...
var criaComponentButtonRemover = function criaComponentButtonRemover(removerNota, posicao) {
    var props = {
        key: 'note-title-remover',
        className: 'note__control',
        type: 'button',
        click: function click(event) {
            return props.remove(event, posicao);
        }
    };
...
var criaComponentButtonConcluido = function criaComponentButtonConcluido(adicionarNota, posicao, notaAlterada) {
    var props = {
...
var FormNotas = function FormNotas(_ref) {
    ...
    var formTextarea = criaComponenteFormTextarea(notaAlterada, posicao);
    var buttonRemover = criaComponentButtonRemover(removerNota, posicao);
    var buttonConcluido = criaComponentButtonConcluido(adicionarNota, posicao, notaAlterada);
...
var _pagina = __webpack_require__(30);
...
var _listaNotas = __webpack_require__(15);

var _listaNotas2 = _interopRequireDefault(_listaNotas);

var _formNotas = __webpack_require__(16);
...
var montaFormNotas = function montaFormNotas(adicionarNota, removerNota, editaFormulario) {
    var props = {
        key: 'form-note',
        notaAtual: new _nota2.default('', ''),
        adicionarNota: adicionarNota, //adicionarNota: adicionarNota
        removerNota: removerNota, //removerNota: removerNota
...
var montaSecaoNotas = function montaSecaoNotas(listaNotas, adicionarNota, removerNota, editaFormulario) {
    var props = {
        key: 'section-notes',
...
var Pagina = function (_React$Component) {
    ...
    function Pagina(props) {
        ...
        _this.editaFormulario = _this.editaFormulario.bind(_this);
    ...
    _createClass(Pagina, [{
        ...
        key: 'editaFormulario',
        value: function editaFormulario(posicao) {
        ...
        value: function render() {
            ...
            var formNotas = montaFormNotas(this.adicionarNota, this.removerNota, this.editaFormulario);
            var secaoNotas = montaSecaoNotas(this.state.listaNotas, this.adicionarNota, this.removerNota, this.editaFormulario);
...
var montaUmFormNotas = function montaUmFormNotas(posicao, listaNotas, removerNota, adicionarNota, editaFormulario) {
    var props = {
        key: posicao,
...
var SecaoNotas = function SecaoNotas(_ref) {
    var listaNotas = _ref.listaNotas,
        removerNota = _ref.removerNota,
        adicionarNota = _ref.adicionarNota,
        editaFormulario = _ref.editaFormulario;
    ...
    return _react2.default.createElement(
        ...
        listaNotas.pegaTodos().map(function (notaAtual, posicao) {
            return montaUmFormNotas(posicao, listaNotas, removerNota, adicionarNota, editaFormulario);
        })
    );
};
